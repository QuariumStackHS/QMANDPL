...
public class Quarium_SBC extends Quarbush implements IGrowable
{
    ...
    {
        return p_149854_1_ == blocks.Quarium_Block;
    }


    public void updateTick(World p_149674_1_, int p_149674_2_, int p_149674_3_, int p_149674_4_, Random p_149674_5_)
    {
    	if (p_149674_1_.rand.nextInt(20) == 0) {
    ...
    {
        return items.Quarium_SEED;
    }

    protected Item func_149865_P()
    {
        return items.Quarium_SCRAP;
    }
    ...
    public ArrayList<ItemStack> getDrops(World world, int x, int y, int z, int metadata, int fortune)
    {
        ...
        if (metadata >= 7 && world.rand.nextInt(20) == 0)
            ret.add(new ItemStack(items.Quarium_ingot));
        if (metadata >= 7 && world.rand.nextInt(4) == 0)
            ret.add(new ItemStack(items.Quarium_SEED));
        return ret;
    }
}