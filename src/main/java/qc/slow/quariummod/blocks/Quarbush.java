...
public class Quarbush extends Block implements IPlantable
{
    private static final String __OBFID = "CL_00000208";

    protected Quarbush(Material p_i45395_1_)
    {
        super(p_i45395_1_);
    ...
    {
        return p_149854_1_ == Blocks.grass || p_149854_1_ == Blocks.dirt || p_149854_1_ == Blocks.farmland || p_149854_1_ == blocks.Quarium_Block;
    }
    ...
    {
        if (this == blocks.Quarium_SB)          return Crop;     
        return Plains;
    }
