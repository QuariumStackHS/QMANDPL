...
import qc.slow.quariummod.items.itemss.Q_MT;
...
public class items {
	...
	public static ToolMaterial SAMARIUMMT=EnumHelper.addToolMaterial("SAMARIUMMT", 4, 400000, 24.0f, 12.5f, 50);
	
	public static ToolMaterial QUARIUM=EnumHelper.addToolMaterial("QUARIUM", 4, 18000, 19.0f, 9.0f, 14);
	public static ToolMaterial QUARIUMMT=EnumHelper.addToolMaterial("QUARIUMMT", 4, 72000, 19.0f, 11.0f, 14);
	...
	public static Item Quarium_Sword,Quarium_Pickaxe,Quarium_Hoe,Quarium_Axe,Quarium_Shovel,Quarium_Mutlitool;
	public static Item Samarium_Sword,Samarium_Pickaxe,Samarium_Hoe,Samarium_Axe,Samarium_Shovel,Samarium_Mutlitool;
public static void init() {
	...
	Quarium_Mutlitool=new Q_MT(QUARIUMMT).setCreativeTab(Main.QuariumTab).setUnlocalizedName("Quarium_Mutlitool").setTextureName(Ref.MOD_ID+":Quarium_Mutlitool");
	...
	Samarium_Mutlitool=new Q_MT(SAMARIUMMT).setCreativeTab(Main.QuariumTab).setUnlocalizedName("Quarium_Mutlitool").setTextureName(Ref.MOD_ID+":Quarium_Mutlitool");
...
public static void register() {
	...
	GameRegistry.registerItem(Quarium_Mutlitool, "Quarium_Mutlitool");
	...
	GameRegistry.registerItem(Samarium_Mutlitool,"Samarium_Mutlitool");
